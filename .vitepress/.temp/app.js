...
import { C as treatAsHtml, S as normalize, _ as isActive, a as Content, b as isShell, c as withBase, d as siteDataRef, f as useData$1, g as inBrowser, l as dataSymbol, m as createTitle, n as createRouter, o as onContentUpdated, p as EXTERNAL_URL_RE, r as useRoute, s as pathToFile, t as RouterSymbol, u as initData, v as isExternal, w as ClientOnly, x as mergeHead, y as isObject } from "./client.DrWFShLr.js";
...
import { Fragment, computed, createBlock, createCommentVNode, createSSRApp, createTextVNode, createVNode, defineAsyncComponent, defineComponent, h, inject, mergeProps, nextTick, onBeforeUnmount, onMounted, onUnmounted, onUpdated, openBlock, provide, readonly, ref, renderList, renderSlot, resolveComponent, resolveDynamicComponent, shallowReadonly, shallowRef, toDisplayString, toHandlers, unref, useSSRContext, useSlots, useTemplateRef, watch, watchEffect, watchPostEffect, withCtx, withKeys } from "vue";
import { onKeyStroke, useMediaQuery, useNavigatorLanguage, useScrollLock, useWindowScroll, useWindowSize } from "@vueuse/core";
...
//#endregion
//#region .vitepress/theme/index.js
var theme_default = {
	extends: {
