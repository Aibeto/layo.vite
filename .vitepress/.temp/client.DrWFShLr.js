import { computed, defineComponent, h, inject, markRaw, nextTick, onMounted, reactive, readonly, ref, shallowRef, watch } from "vue";
...
var _siteData_default = deserializeFunctions(JSON.parse("{\"lang\":\"zh-CN\",\"dir\":\"ltr\",\"title\":\"LAYOSERVE\",\"description\":\"A VitePress Blog with Theme\",\"base\":\"/\",\"head\":[],\"router\":{\"prefetchLinks\":true},\"appearance\":true,\"themeConfig\":{\"nav\":[],\"sidebar\":[{}],\"socialLinks\":[{\"icon\":\"github\",\"link\":\"https://github.com/RAINCRAT/layo.vite\"}],\"search\":{\"provider\":\"local\"}},\"locales\":{},\"cleanUrls\":true,\"additionalConfig\":{}}"));
//#endregion
...
//#endregion
export { treatAsHtml as C, normalize as S, isActive as _, Content as a, isShell as b, withBase as c, siteDataRef as d, useData as f, inBrowser as g, escapeRegExp as h, useRouter as i, dataSymbol as l, createTitle as m, createRouter as n, onContentUpdated as o, EXTERNAL_URL_RE as p, useRoute as r, pathToFile as s, RouterSymbol as t, initData as u, isExternal as v, ClientOnly as w, mergeHead as x, isObject as y };
